...
class CheckNotEnemy(TaskNode):
    """Task in which the agent check if not enemy in view."""
...
class CloseDoorNode(TaskNode):
    """Task in which the agent closes the door."""
    def run(self):
        print('SUCCESS - Ok, the door is close now :)')
        return TaskStatus.SUCCESS
